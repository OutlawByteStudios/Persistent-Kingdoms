...
meshes = [
  ...
  ("banner_m14", 0, "pw_banner_m15", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_m15", 0, "pw_banner_m16", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_m16", 0, "pw_banner_m17", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_m17", 0, "pw_banner_m18", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_m18", 0, "pw_banner_m19", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_m19", 0, "pw_banner_m20", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_m20", 0, "pw_banner_m21", 0, 0, 0, -90, 0, 0, 1, 1, 1),
