...
"),
  ...
  ("anim_flute_1", "*Flute* 1"),
  ("anim_flute_2", "*Flute* 2"),
  ("anim_flute_3", "*Flute* 3"),
  ("anim_flute_4", "*Flute* 4"),
  ("anim_vielle_1", "*Vielle* 1"),
  ("anim_vielle_2", "*Vielle* 2"),
  ("anim_vielle_3", "*Vielle* 3"),
  ("anim_vielle_4", "*Vielle* 4"),
