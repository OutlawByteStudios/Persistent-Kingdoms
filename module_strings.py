...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("castle_name_92", "Riverrun"),

  ("castle_name_93", "Rattay"),
  ("castle_name_94", "Sasau"),
  ("castle_name_99", "Monastery"),
  ("castle_name_95", "Ledetchko"),
  ("castle_name_96", "Skalitz"),
  ("castle_name_97", "Talmberg"),
  ("castle_name_98", "Castle Skalicky"),
  ("castle_name_100", "Pirkstein"),

  ("castle_name_101", "Antioch"),
  ("castle_name_102", "Damascus"),
  ("castle_name_103", "Kerak"),
  ("castle_name_104", "Almourol Castle"),
  ("castle_name_105", "Windsor Castle"),
  ("castle_name_106", "Warwick Castle"),
  ("castle_name_107", "Constantinople"),
  ("castle_name_108", "Vienna"),
  ("castle_name_109", "Prague"),
  ("castle_name_110", "Paris"),

  ("castle_name_110", "Vizima"),
  ("castle_name_111", "Novigrad"),
  ("castle_name_112", "Kaer Morhen"),
  ("castle_name_113", "Beauclair"),
  ("castle_name_114", "Oxenfurt"),
  ("castle_name_115", "Kaer Trolde"),
