...
"),
  ...
  ("teleport_to_you", "teleport to you"),
...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("castle_name_70", "Solitude"),
  ("castle_name_71", "Whiterun"),
  ("castle_name_72", "Fort_Dawnguard"),
  ("castle_name_73", "Riften"),
  ("castle_name_74", "Markarth"),
  ("castle_name_75", "Windhelm"),
  ...
  ("castle_name_93", "Sunspear"),
  ("castle_name_94", "Riverrun"),
  ("castle_name_95", "Castamere"),

  ("castle_name_96", "Rattay"),
  ("castle_name_97", "Sasau"),
  ("castle_name_98", "Monastery"),
  ("castle_name_99", "Ledetchko"),
  ("castle_name_100", "Skalitz"),
  ("castle_name_101", "Talmberg"),
  ("castle_name_102", "Talmberg Castle"),
  ("castle_name_103", "Castle Skalicky"),
  ("castle_name_104", "Pirkstein"),

  ("castle_name_105", "Antioch"),
  ("castle_name_106", "Damascus"),
  ("castle_name_107", "Kerak"),
  ("castle_name_108", "Almourol Castle"),
  ("castle_name_109", "Windsor Castle"),
  ("castle_name_110", "Warwick Castle"),
  ("castle_name_111", "Constantinople"),
  ("castle_name_112", "Vienna"),
  ("castle_name_113", "Prague"),
  ("castle_name_114", "Paris"),

  ("castle_name_115", "Vizima"),
  ("castle_name_116", "Novigrad"),
  ("castle_name_117", "Kaer Morhen"),
  ("castle_name_118", "Beauclair"),
  ("castle_name_119", "Oxenfurt"),
  ("castle_name_120", "Kaer Trolde"),
