...
scripts.extend([
  ...
  ("cf_handle_fast_equip_request", [
		...
		(assign, reg31, ":from_slot"),
		(display_message, "@equip {reg31}"),
		...
		(ge, ":item_id", "itm_tattered_headcloth"),
		...
		(try_begin),
			...
			(try_for_range, ":other_player_id", 1, ":max_players"), # loop over all players currently looking at the same inventory
			  ...
			  (try_begin),
				(multiplayer_send_3_int_to_player, ":other_player_id", server_event_scene_prop_set_slot, ":container_id", ":from_slot", ":equipped_item"),
			  (try_end),
			(try_end),
  ...
  ("cf_handle_fast_unequip_request", [
	  ...
	  (store_script_param_2, ":sender_player_id"),
		...
		(assign, reg31, ":inventory_length"),
		(display_message, "@len {reg31}"),
		(try_for_range, ":inventory_index", slot_scene_prop_inventory_begin, ":inventory_length"),
			...
			(lt, ":item_at_index", "itm_tattered_headcloth"),
