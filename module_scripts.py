...
scripts.extend([
  ...
  ("initialize_banner_info", # store background colors for all the banners in an array
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_m18", 0xFF295131), 
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n01", 0xFFe7bc10),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n09", 0xFF782829),
