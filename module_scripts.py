    ...
    (else_try),
      ...
      (try_for_range, ":player_id", 1, ":max_players"),
        ...
        (try_begin),
          ...
          (call_script, "script_preset_message", "str_you_have_door_keys", preset_message_faction|preset_message_log|preset_message_small, ":faction_id", 0),
        (else_try),
          (eq, ":key_slot", faction_admin_action_toggle_player_money_key),
          (call_script, "script_preset_message", "str_you_have_money_keys",preset_message_faction|preset_message_log|preset_message_small, ":faction_id", 0),
        (else_try),
          (eq, ":key_slot", slot_player_has_faction_item_key),
          (call_script, "script_preset_message", "str_you_have_item_keys",preset_message_faction|preset_message_log|preset_message_small, ":faction_id", 0),
        (else_try),
          (eq, ":key_slot", slot_player_can_faction_announce),
          (call_script, "script_preset_message", "str_you_have_announcers",preset_message_faction|preset_message_log|preset_message_small, ":faction_id", 0),
        (try_end),
      (try_end),
    ...
    (else_try),
      ...
      (try_for_range, ":player_id", 1, ":max_players"),
        ...
        (try_begin),
          ...
          (eq, ":player_id", ":value_1"),
          (call_script, "script_preset_message", "str_you_are_a_marshal",preset_message_faction|preset_message_log|preset_message_small, ":faction_id", 0),
        (try_end),
