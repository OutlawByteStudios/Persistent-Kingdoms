...
("cf_try_execute_animation", # clients, server: check if an agent can play an animation; if successful, on clients return test result in reg0 or send a message, execute if the server
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (assign, ":sheathe_weapons", 0), # sheathe weapon and shield
      ...
      (try_begin), # the first script parameter is the name string id, which must be in the appropriate section of module_strings.py
        ...
        animation_menu_entry("str_anim_clap", animation="anim_man_clap", woman_alt_animation="anim_woman_clap", weapon_requirement=-1, sheathe_weapons=1),
        animation_menu_entry("str_anim_raise_sword", animation="anim_pose_raise_sword"),
        animation_menu_entry("str_anim_sit", animation="anim_sitting_pillow_male", woman_alt_animation="anim_sitting_pillow_female", weapon_requirement=-1, prevent_if_moving=1, prevent_if_on_horse=1, upper_body_only=0, sheathe_weapons=1),
        animation_menu_entry("str_anim_surrender", animation="anim_surrender", weapon_requirement=-1, sheathe_weapons=1),
        animation_menu_entry("str_anim_hands_on_hips", animation="anim_pose_hands_on_hips", weapon_requirement=-1, prevent_if_moving=1, sheathe_weapons=1),
        animation_menu_entry("str_anim_arms_crossed", animation="anim_pose_arms_crossed", weapon_requirement=-1, prevent_if_moving=1, sheathe_weapons=1),
        ...
        animation_menu_entry("str_anim_peeing", animation="anim_peeing", weapon_requirement=-1, prevent_if_moving=1, sheathe_weapons=1),
        animation_menu_entry("str_anim_hand_on_chest", animation="anim_hand_on_chest", weapon_requirement=-1, sheathe_weapons=1),
        animation_menu_entry("str_anim_bow", animation="anim_bow", prevent_if_moving=1, weapon_requirement=-1, prevent_if_on_horse=1, upper_body_only=0, sheathe_weapons=1),
        animation_menu_entry("str_anim_kneel", animation="anim_kneel", prevent_if_moving=1, prevent_if_on_horse=1, upper_body_only=0, sheathe_weapons=1),
        animation_menu_entry("str_anim_sleeping", animation="anim_sleeping", weapon_requirement=-1, prevent_if_moving=1, prevent_if_on_horse=1, upper_body_only=0, sheathe_weapons=1),
        animation_menu_entry("str_anim_pray", animation="anim_pray", weapon_requirement=-1, prevent_if_moving=1, prevent_if_on_horse=1, upper_body_only=0, sheathe_weapons=1),
        animation_menu_entry("str_anim_beg", animation="anim_beg", weapon_requirement=-1, prevent_if_moving=1, prevent_if_on_horse=1, upper_body_only=0, sheathe_weapons=1),
        animation_menu_entry("str_anim_track", animation="anim_tracking", prevent_if_moving=1, prevent_if_on_horse=1, upper_body_only=0, sheathe_weapons=1),
