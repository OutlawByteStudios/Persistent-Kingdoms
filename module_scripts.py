   ...
   [(store_script_param, ":sender_player_id", 1),
    ...
    (try_begin), # section of events received by clients from the server
      ...
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", server_event_set_player_is_using_ballista),
        (store_script_param, "$g_is_operating_ballista", 3),
      (try_end),
    ...
    (else_try), # section of events received by server from the clients
      ...
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", client_event_rotate_ballista),
        (try_begin),
          (player_get_agent_id, ":agent_id", ":sender_player_id"),
          (agent_is_active, ":agent_id"),
          (agent_is_alive, ":agent_id"),
          (agent_get_slot, ":instance_id", ":agent_id", slot_agent_ballista_on_use),
          (prop_instance_get_position, pos1, ":instance_id"),
          (store_script_param, ":x_rotation", 3),
          (store_script_param, ":y_rotation", 4),
          (store_script_param, ":z_rotation", 5),
          (position_rotate_x, pos1, ":x_rotation"),
          (position_rotate_y, pos1, ":y_rotation"),
          (position_rotate_z, pos1, ":z_rotation"),
