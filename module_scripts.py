   ...
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    ("cf_setup_singings", [
      ...
      (try_for_players, ":other_player_id"),
        ...
        (player_get_agent_id, ":other_agent_id", ":other_player_id"),
        (agent_is_active, ":other_agent_id"),
        (agent_get_slot, ":sound", ":other_agent_id", slot_agent_playing_music),
        (gt, ":sound", -1),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_agent_play_sound, ":other_agent_id", ":sound"),
        (try_begin),
          (is_between, ":sound", lute_sounds_begin, lyre_sounds_begin),
          #(agent_set_animation, ":other_agent_id", "anim_play_lute", 1),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_animation, ":other_agent_id", "anim_play_lute", 1),
        (else_try),
          (is_between, ":sound", lyre_sounds_begin, horn_sounds_begin),
          #(agent_set_animation, ":other_agent_id", "anim_play_lyre", 1),
          (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_animation, ":other_agent_id", "anim_play_lyre", 1),
        (try_end),
      (try_end),
    ]),
])
