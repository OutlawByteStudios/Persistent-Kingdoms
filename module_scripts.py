...
scripts.extend([
  ...
  ("initialize_banner_info", # store background colors for all the banners in an array
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_m19", 0xFF866e00), 
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n06", 0xFF244876),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n09", 0xFF973131),
