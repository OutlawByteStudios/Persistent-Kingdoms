...
scene_props = [
  ...
  ("cm_civ_cart",sokf_static_movement|spr_use_time(1),"cm_civ_cart","bo_cm_civ_cart", spr_cart_triggers(horse="itm_cart_horse", detach_offset=110, detach_rotation=-20, inventory_count=48, max_item_length=250, access_distance=-180)),
