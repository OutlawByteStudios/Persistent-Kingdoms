...
scene_props = [
  ...
  ("cm_buy_gnezdovo_helmet",spr_buy_item_flags(10),"gnezdovo_helm_b","bo_pw_armor_head", spr_buy_item_triggers("itm_gnezdovo_helm_b", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
