...
scene_props = [
  ...
  ("pk_pine_9",spr_tree_flags(),"pk_pine_9","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_pine_10",spr_tree_flags(),"pk_pine_10","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_pine_11",spr_tree_flags(),"pk_pine_11","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_pine_12",spr_tree_flags(),"pk_pine_12","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_pine_13",spr_tree_flags(),"pk_pine_13","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_snowy_pine_2",spr_tree_flags(),"pk_snowy_pine_2","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_beech_1",spr_tree_flags(),"pk_beech_1","", spr_tree_triggers(full_hp=2200, fell_hp=1000, resource_imod=imod_battered)),
  ("pk_beech_2",spr_tree_flags(),"pk_beech_2","", spr_tree_triggers(full_hp=2200, fell_hp=1000, resource_imod=imod_battered)),
  ("pk_beech_3",spr_tree_flags(),"pk_beech_3","", spr_tree_triggers(full_hp=2200, fell_hp=1000, resource_imod=imod_battered)),
  ("pk_tree_1",spr_tree_flags(),"pk_tree_1","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_tree_2",spr_tree_flags(),"pk_tree_2","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_tree_3",spr_tree_flags(),"pk_tree_3","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_tree_4",spr_tree_flags(),"pk_tree_4","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_tree_5",spr_tree_flags(),"pk_tree_5","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_tree_6",spr_tree_flags(),"pk_tree_6","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_tree_7",spr_tree_flags(),"pk_tree_7","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pk_tree_8",spr_tree_flags(),"pk_tree_8","", spr_tree_triggers(full_hp=2200, fell_hp=1000)),

  ("pk_apple_tree_1",spr_tree_flags(),"pk_apple_tree_1","", spr_fruit_tree_triggers(fruit="itm_red_apple", count=10, height=350, width=150, fruiting_interval=1200, full_hp=600, fell_hp=100, regrow_interval=1800)),
  ("pk_apple_tree_2",spr_tree_flags(),"pk_apple_tree_2","", spr_fruit_tree_triggers(fruit="itm_red_apple", count=10, height=350, width=150, fruiting_interval=1200, full_hp=600, fell_hp=100, regrow_interval=1800)),
