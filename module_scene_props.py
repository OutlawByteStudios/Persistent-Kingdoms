...
scene_props = [
  ...
  ("cm_buy_chapel_de_fer_cloth",spr_buy_item_flags(7),"chapel_de_fer_cloth2","bo_pw_armor_head", spr_buy_item_triggers("itm_chapel_de_fer_cloth2", resources=["itm_iron_bar_short","itm_linen_cloth_small"], engineer=2)),
  ("cm_buy_gnezdovo_helmet",spr_buy_item_flags(7),"gnezdovo_helm_a","bo_pw_armor_head", spr_buy_item_triggers("itm_gnezdovo_helm_a", resources=["itm_iron_bar_short","itm_leather_piece"], engineer=2)),
  ...
  ("cm_buy_decorated_saracen_helmet_with_mail",spr_buy_item_flags(10),"helm_saracin_j","bo_pw_armor_head", spr_buy_item_triggers("itm_helm_saracin_j", resources=["itm_iron_bar_short","itm_linen_cloth_small"], engineer=4)),
  ...
  ("cm_buy_chapel_de_fer_with_mail_1",spr_buy_item_flags(11),"chapel_de_fer_mail2","bo_pw_armor_head", spr_buy_item_triggers("itm_chapel_de_fer_mail2", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_chapel_de_fer_with_mail_2",spr_buy_item_flags(11),"chapel_de_fer_mail3","bo_pw_armor_head", spr_buy_item_triggers("itm_chapel_de_fer_mail3", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_open_sallet_with_coif",spr_buy_item_flags(11),"open_salet_coif","bo_pw_armor_head", spr_buy_item_triggers("itm_open_salet_coif", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_zitta_bascinet_without_visor",spr_buy_item_flags(11),"zitta_bascinet_novisor","bo_pw_armor_head", spr_buy_item_triggers("itm_zitta_bascinet_novisor", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ...
  ("cm_buy_gulam_helmet_with_blue_cloth",spr_buy_item_flags(12),"gulam_helm_c_market","bo_pw_armor_head", spr_buy_item_triggers("itm_gulam_helm_c_market", resources=["itm_iron_bar_short","itm_linen_cloth_small"], engineer=4)),
  ...
  ("cm_buy_open_sallet_with_neckguard",spr_buy_item_flags(15),"north_sallet","bo_pw_armor_head", spr_buy_item_triggers("itm_north_sallet", resources=[("itm_iron_bar_short",2)], engineer=5)),
  ("cm_buy_closed_sallet_with_neckguard",spr_buy_item_flags(15),"north_neckguard","bo_pw_armor_head", spr_buy_item_triggers("itm_north_neckguard", resources=[("itm_iron_bar_short",2)], engineer=5)),
  ("cm_buy_litchina_helmet",spr_buy_item_flags(15),"litchina_helm","bo_pw_armor_head", spr_buy_item_triggers("itm_litchina_helm", resources=[("itm_iron_bar_short",2)], engineer=5)),
  ...
  ("cm_buy_open_zitta_bascinet",spr_buy_item_flags(17),"zitta_bascinet_open","bo_pw_armor_head", spr_buy_item_triggers("itm_zitta_bascinet_open", resources=[("itm_iron_bar_short",2),"itm_leather_piece"], engineer=6)),
  ("cm_buy_zitta_bascinet",spr_buy_item_flags(17),"zitta_bascinet","bo_pw_armor_head", spr_buy_item_triggers("itm_zitta_bascinet", resources=[("itm_iron_bar_short",2),"itm_leather_piece"], engineer=6)),
  ("cm_buy_open_pigface_helmet",spr_buy_item_flags(17),"pigface_klappvisor_open","bo_pw_armor_head", spr_buy_item_triggers("itm_pigface_klappvisor_open", resources=[("itm_iron_bar_short",2),"itm_iron_piece"], engineer=6)),
  ("cm_buy_pigface_helmet",spr_buy_item_flags(17),"pigface_klappvisor","bo_pw_armor_head", spr_buy_item_triggers("itm_pigface_klappvisor", resources=[("itm_iron_bar_short",2),"itm_iron_piece"], engineer=6)),
  ("cm_buy_open_klappvisier",spr_buy_item_flags(17),"klappvisier_open","bo_pw_armor_head", spr_buy_item_triggers("itm_klappvisier_open", resources=[("itm_iron_bar_short",2),"itm_iron_piece"], engineer=6)),
  ("cm_buy_klappvisier",spr_buy_item_flags(17),"klappvisier","bo_pw_armor_head", spr_buy_item_triggers("itm_klappvisier", resources=[("itm_iron_bar_short",2),"itm_iron_piece"], engineer=6)),
  ...
  ("cm_buy_sultan_helmet",spr_buy_item_flags(20),"helm_sultan_saracens_market","bo_pw_armor_head", spr_buy_item_triggers("itm_helm_sultan_saracens_market", resources=["itm_iron_bar","itm_linen_cloth_small"], engineer=6)),
  ...
  ("cm_buy_great_bascinet",spr_buy_item_flags(21),"greatbascinet1","bo_pw_armor_head", spr_buy_item_triggers("itm_greatbascinet1", resources=["itm_iron_bar","itm_iron_bar_short","itm_linen_cloth_small"], engineer=6)),
  ...
  ("cm_buy_weimar_helmet",spr_buy_item_flags(21),"weimarhelm","bo_pw_armor_head", spr_buy_item_triggers("itm_weimarhelm", resources=["itm_iron_bar","itm_iron_bar_short","itm_linen_cloth_small"], engineer=6)),
