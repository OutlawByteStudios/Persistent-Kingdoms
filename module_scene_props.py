...
scene_props = [
  ...
  ("pw_item_chest_invisible",sokf_dynamic_physics|sokf_missiles_not_attached|sokf_invisible|spr_chest_flags(1),"pw_invisible_chest","bo_pw_invisible_chest",    [(ti_on_scene_prop_start_use,
