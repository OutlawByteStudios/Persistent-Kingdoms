...
scene_props = [
  ...
  ("cm_buy_blue_shirt",spr_buy_item_flags(14),"shirt_c","bo_pw_armor_body", spr_buy_item_triggers("itm_shirt_c", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_green_shirt",spr_buy_item_flags(14),"shirt_b","bo_pw_armor_body", spr_buy_item_triggers("itm_shirt_b", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_decorated_khergit_vest",spr_buy_item_flags(14),"khergit_vest_d","bo_pw_armor_body", spr_buy_item_triggers("itm_khergit_vest_d", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_white_khergit_vest",spr_buy_item_flags(14),"khergit_vest_a","bo_pw_armor_body", spr_buy_item_triggers("itm_khergit_vest_a", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_gold_tourney_armor",spr_buy_item_flags(14),"padded_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_padded_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_gold_ragged_armor",spr_buy_item_flags(14),"ragged_armour_a","bo_pw_armor_body", spr_buy_item_triggers("itm_ragged_armour_a", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_byrnie_with_green_tunic",spr_buy_item_flags(14),"byrnie_e","bo_pw_armor_body", spr_buy_item_triggers("itm_byrnie_e", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_byrnie_with_blue_tunic",spr_buy_item_flags(14),"byrnie_f","bo_pw_armor_body", spr_buy_item_triggers("itm_byrnie_f", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_studded_coat_with_mail",spr_buy_item_flags(14),"studded_coat_mail_a","bo_pw_armor_body", spr_buy_item_triggers("itm_studded_coat_mail_a", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_red_gambeson",spr_buy_item_flags(14),"gambeson_red","bo_pw_armor_body", spr_buy_item_triggers("itm_gambeson_red", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_brown_gambeson",spr_buy_item_flags(14),"gambeson_brown","bo_pw_armor_body", spr_buy_item_triggers("itm_gambeson_brown", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_gambeson",spr_buy_item_flags(14),"gambeson","bo_pw_armor_body", spr_buy_item_triggers("itm_gambeson", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_padded_leather",spr_buy_item_flags(14),"fred_padded_leather","bo_pw_armor_body", spr_buy_item_triggers("itm_fred_padded_leather", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_padded_leather_with_cape",spr_buy_item_flags(14),"fred_padded_leather_cowl","bo_pw_armor_body", spr_buy_item_triggers("itm_fred_padded_leather_cowl", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_aketon",spr_buy_item_flags(14),"aketon","bo_pw_armor_body", spr_buy_item_triggers("itm_aketon", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_aketon_with_kneecops",spr_buy_item_flags(14),"aketon_kneecops","bo_pw_armor_body", spr_buy_item_triggers("itm_aketon_kneecops", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_peasant_mail_with_cape",spr_buy_item_flags(14),"fred_peasant_mail","bo_pw_armor_body", spr_buy_item_triggers("itm_fred_peasant_mail", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_brown_gambeson_with_cape",spr_buy_item_flags(14),"cwe_archer_armor_2","bo_pw_armor_body", spr_buy_item_triggers("itm_cwe_archer_armor_2", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_black_gambeson_with_cape",spr_buy_item_flags(14),"cwe_archer_armor_1","bo_pw_armor_body", spr_buy_item_triggers("itm_cwe_archer_armor_1", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_padded_mail_with_white_shirt",spr_buy_item_flags(14),"padded_mail_a","bo_pw_armor_body", spr_buy_item_triggers("itm_padded_mail_a", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_padded_mail_with_green_shirt",spr_buy_item_flags(14),"padded_mail_b","bo_pw_armor_body", spr_buy_item_triggers("itm_padded_mail_b", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_light_hauberk",spr_buy_item_flags(14),"hauberk","bo_pw_armor_body", spr_buy_item_triggers("itm_hauberk", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_green_light_brigandine",spr_buy_item_flags(14),"brigandine_green","bo_pw_armor_body", spr_buy_item_triggers("itm_brigandine_green", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_blue_lamellar_vest",spr_buy_item_flags(14),"sar_lamellar_vest_blue","bo_pw_armor_body", spr_buy_item_triggers("itm_sar_lamellar_vest_blue", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_red_lamellar_vest_with_mail",spr_buy_item_flags(14),"sar_lamellar_vest_mail_red","bo_pw_armor_body", spr_buy_item_triggers("itm_sar_lamellar_vest_mail_red", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_black_gambeson_with_mail",spr_buy_item_flags(14),"cwe_sergeant_armor_2","bo_pw_armor_body", spr_buy_item_triggers("itm_cwe_sergeant_armor_2", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_red_gambeson_with_mail",spr_buy_item_flags(14),"cwe_sergeant_armor_3","bo_pw_armor_body", spr_buy_item_triggers("itm_cwe_sergeant_armor_3", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_brown_light_brigandine_with_mail",spr_buy_item_flags(14),"brigandine_brown_mail","bo_pw_armor_body", spr_buy_item_triggers("itm_brigandine_brown_mail", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_light_saracen_armor",spr_buy_item_flags(14),"turk_bandit_b","bo_pw_armor_body", spr_buy_item_triggers("itm_turk_bandit_b", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_light_saracen_infantry_armor",spr_buy_item_flags(14),"turk_bandit_c","bo_pw_armor_body", spr_buy_item_triggers("itm_turk_bandit_c", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_rus_lamellar_armor",spr_buy_item_flags(14),"rus_lamellar_a","bo_pw_armor_body", spr_buy_item_triggers("itm_rus_lamellar_a", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_light_kuyak",spr_buy_item_flags(14),"kuyak_a","bo_pw_armor_body", spr_buy_item_triggers("itm_kuyak_a", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_saracen_infantry_armor",spr_buy_item_flags(14),"sar_infantry_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_sar_infantry_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_medium_saracen_armor",spr_buy_item_flags(14),"cwe_armor_medium_tyrk_d","bo_pw_armor_body", spr_buy_item_triggers("itm_cwe_armor_medium_tyrk_d", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_heavy_kuyak",spr_buy_item_flags(14),"kuyak_b","bo_pw_armor_body", spr_buy_item_triggers("itm_kuyak_b", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_saracen_lamellar_armor",spr_buy_item_flags(14),"sar_lamellar_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_sar_lamellar_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_lamellar_armor",spr_buy_item_flags(14),"drz_lamellar_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_drz_lamellar_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_heavy_saracen_armor",spr_buy_item_flags(14),"armor_medium_tyrk_f","bo_pw_armor_body", spr_buy_item_triggers("itm_armor_medium_tyrk_f", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_heavy_hauberk",spr_buy_item_flags(14),"hauberk3","bo_pw_armor_body", spr_buy_item_triggers("itm_hauberk3", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_rus_scale_armor",spr_buy_item_flags(14),"rus_scale","bo_pw_armor_body", spr_buy_item_triggers("itm_rus_scale", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_heavy_hauberk_with_plate",spr_buy_item_flags(14),"hauberk2","bo_pw_armor_body", spr_buy_item_triggers("itm_hauberk2", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_corrazina_green",spr_buy_item_flags(14),"corrazina_green","bo_pw_armor_body", spr_buy_item_triggers("itm_corrazina_green", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_corrazina_red",spr_buy_item_flags(14),"corrazina_red","bo_pw_armor_body", spr_buy_item_triggers("itm_corrazina_red", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_sarranid_guard_armor",spr_buy_item_flags(14),"sarranid_guard_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_guard_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_blue_brigandine_with_plate",spr_buy_item_flags(14),"brigandine_blue","bo_pw_armor_body", spr_buy_item_triggers("itm_brigandine_blue", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_red_brigandine_with_plate",spr_buy_item_flags(14),"brigandine_red_a","bo_pw_armor_body", spr_buy_item_triggers("itm_brigandine_red_a", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_elite_lamellar_armor",spr_buy_item_flags(14),"drz_elite_lamellar_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_drz_elite_lamellar_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_ghulam_lamellar_armor",spr_buy_item_flags(14),"ghulam_heavy_cavalryman_3","bo_pw_armor_body", spr_buy_item_triggers("itm_ghulam_heavy_cavalryman_3", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_red_brigandine_with_plate_and_mail",spr_buy_item_flags(14),"brigandine_red_mail","bo_pw_armor_body", spr_buy_item_triggers("itm_brigandine_red_mail", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_black_brigandine_with_plate_and_mail",spr_buy_item_flags(14),"brigandine_black_mail","bo_pw_armor_body", spr_buy_item_triggers("itm_brigandine_black_mail", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_sultan_armor",spr_buy_item_flags(14),"armor_sultan_saracens","bo_pw_armor_body", spr_buy_item_triggers("itm_armor_sultan_saracens", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_blue_churburg",spr_buy_item_flags(14),"churburg_13","bo_pw_armor_body", spr_buy_item_triggers("itm_churburg_13", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_decorated_red_churburg",spr_buy_item_flags(14),"churburg_13_brass","bo_pw_armor_body", spr_buy_item_triggers("itm_churburg_13_brass", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_decorated_grey_churburg",spr_buy_item_flags(14),"churburg","bo_pw_armor_body", spr_buy_item_triggers("itm_churburg", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_milanese_plate",spr_buy_item_flags(14),"armour_new_b","bo_pw_armor_body", spr_buy_item_triggers("itm_armour_new_b", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("cm_buy_gothic_plate",spr_buy_item_flags(14),"gothic_armour_plain","bo_pw_armor_body", spr_buy_item_triggers("itm_gothic_armour_plain", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ...
  ("cm_buy_mail_gauntlets",spr_buy_item_flags(2),"mail_gauntlets_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_mail_gauntlets", resources=["itm_leather_piece"], tailoring=2, engineer=4)),
  ("cm_buy_demi_gauntlets",spr_buy_item_flags(2),"demi_gauntlets_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_demi_gauntlets", resources=["itm_leather_piece"], tailoring=2, engineer=4)),
  ("cm_buy_saracen_gauntlets",spr_buy_item_flags(2),"gauntlets_arabs_a_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_gauntlets_arabs_a", resources=["itm_leather_piece"], tailoring=2, engineer=4)),
  ("cm_buy_finger_gauntlets",spr_buy_item_flags(2),"finger_gauntlets_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_finger_gauntlets", resources=["itm_leather_piece"], tailoring=2, engineer=4)),
  ("cm_buy_decorated_saracen_gauntlets",spr_buy_item_flags(2),"gauntlets_arabs_b_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_gauntlets_arabs_b", resources=["itm_leather_piece"], tailoring=2, engineer=4)),
  ("cm_buy_hourglass_gauntlets",spr_buy_item_flags(2),"hourglass_gauntlets_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_hourglass_gauntlets", resources=["itm_leather_piece"], tailoring=2, engineer=4)),
  ("cm_buy_decorated_hourglass_gauntlets",spr_buy_item_flags(2),"hourglass_gauntlets_ornate_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_hourglass_gauntlets_ornate", resources=["itm_leather_piece"], tailoring=2, engineer=4)),
  ...
  ("cm_buy_rus_splinted_greaves",spr_buy_item_flags(4),"rus_splint_greaves","bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_splint_greaves", resources=[("itm_leather_piece",2)], tailoring=2, engineer=3)),
  ("cm_buy_splinted_greaves",spr_buy_item_flags(4),"splinted_greaves_nospurs","bo_pw_armor_foot", spr_buy_item_triggers("itm_splinted_greaves_nospurs", resources=[("itm_leather_piece",2)], tailoring=2, engineer=3)),
  ("cm_buy_steel_greaves",spr_buy_item_flags(4),"narf_greaves2","bo_pw_armor_foot", spr_buy_item_triggers("itm_narf_greaves2", resources=[("itm_leather_piece",2)], tailoring=2, engineer=3)),
  ("cm_buy_shynbaulds",spr_buy_item_flags(4),"shynbaulds","bo_pw_armor_foot", spr_buy_item_triggers("itm_shynbaulds", resources=[("itm_leather_piece",2)], tailoring=2, engineer=3)),
  ("cm_buy_polished_steel_boots",spr_buy_item_flags(4),"narf_greaves","bo_pw_armor_foot", spr_buy_item_triggers("itm_narf_greaves", resources=[("itm_leather_piece",2)], tailoring=2, engineer=3)),
  ("cm_buy_steel_boots",spr_buy_item_flags(4),"steel_greaves","bo_pw_armor_foot", spr_buy_item_triggers("itm_steel_greaves", resources=[("itm_leather_piece",2)], tailoring=2, engineer=3)),
  
  ("cm_buy_tourney_helm_yellow",spr_buy_item_flags(10),"tourney_helm_yellow","bo_pw_armor_head", spr_buy_item_triggers("itm_tourney_helm_yellow", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_saracen_helmet_with_leather",spr_buy_item_flags(10),"helm_saracin_c","bo_pw_armor_head", spr_buy_item_triggers("itm_helm_saracin_c", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_saracen_helmet_with_mail",spr_buy_item_flags(10),"sar_infantry_helmet1","bo_pw_armor_head", spr_buy_item_triggers("itm_sar_infantry_helmet1", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_chapel_de_fer_cloth",spr_buy_item_flags(10),"chapel_de_fer_cloth2","bo_pw_armor_head", spr_buy_item_triggers("itm_chapel_de_fer_cloth2", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_gnezdovo_helmet",spr_buy_item_flags(10),"gnezdovo_helm_a","bo_pw_armor_head", spr_buy_item_triggers("itm_gnezdovo_helm_a", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_bascinet",spr_buy_item_flags(10),"north_helmet","bo_pw_armor_head", spr_buy_item_triggers("itm_north_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_sallet",spr_buy_item_flags(10),"north_noseguard","bo_pw_armor_head", spr_buy_item_triggers("itm_north_noseguard", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_barbuta",spr_buy_item_flags(10),"barbuta1","bo_pw_armor_head", spr_buy_item_triggers("itm_barbuta1", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ...
  ("cm_buy_decorated_saracen_helmet_with_mail",spr_buy_item_flags(10),"helm_saracin_j","bo_pw_armor_head", spr_buy_item_triggers("itm_helm_saracin_j", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ...
  ("cm_buy_chapel_de_fer_with_mail_1",spr_buy_item_flags(10),"chapel_de_fer_mail2","bo_pw_armor_head", spr_buy_item_triggers("itm_chapel_de_fer_mail2", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_chapel_de_fer_with_mail_2",spr_buy_item_flags(10),"chapel_de_fer_mail3","bo_pw_armor_head", spr_buy_item_triggers("itm_chapel_de_fer_mail3", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_open_sallet_with_coif",spr_buy_item_flags(10),"open_salet_coif","bo_pw_armor_head", spr_buy_item_triggers("itm_open_salet_coif", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_zitta_bascinet_without_visor",spr_buy_item_flags(10),"zitta_bascinet_novisor","bo_pw_armor_head", spr_buy_item_triggers("itm_zitta_bascinet_novisor", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_prato_chapel_de_fer",spr_buy_item_flags(10),"prato_chapel_de_fer","bo_pw_armor_head", spr_buy_item_triggers("itm_prato_chapel_de_fer", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_gulam_helmet_with_blue_cloth",spr_buy_item_flags(10),"gulam_helm_c_market","bo_pw_armor_head", spr_buy_item_triggers("itm_gulam_helm_c_market", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_gulam_helmet_with_red_cloth",spr_buy_item_flags(10),"gulam_helm_b_market","bo_pw_armor_head", spr_buy_item_triggers("itm_gulam_helm_b_market", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_gulam_helmet",spr_buy_item_flags(10),"gulam_helm_a","bo_pw_armor_head", spr_buy_item_triggers("itm_gulam_helm_a", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_open_tagancha",spr_buy_item_flags(10),"tagancha_helm_a","bo_pw_armor_head", spr_buy_item_triggers("itm_tagancha_helm_a", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_closed_tagancha",spr_buy_item_flags(10),"tagancha_helm_b","bo_pw_armor_head", spr_buy_item_triggers("itm_tagancha_helm_b", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_nikolskoe_helmet",spr_buy_item_flags(10),"nikolskoe_helm","bo_pw_armor_head", spr_buy_item_triggers("itm_nikolskoe_helm", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_novogrod_helmet",spr_buy_item_flags(10),"novogrod_helm","bo_pw_armor_head", spr_buy_item_triggers("itm_novogrod_helm", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_visored_sallet",spr_buy_item_flags(10),"visored_salet","bo_pw_armor_head", spr_buy_item_triggers("itm_visored_salet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_visored_sallet_with_coif",spr_buy_item_flags(10),"visored_salet_coif","bo_pw_armor_head", spr_buy_item_triggers("itm_visored_salet_coif", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_open_sallet",spr_buy_item_flags(10),"north_aventail","bo_pw_armor_head", spr_buy_item_triggers("itm_north_aventail", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_closed_sallet",spr_buy_item_flags(10),"north_bascinet","bo_pw_armor_head", spr_buy_item_triggers("itm_north_bascinet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_open_sallet_with_neckguard",spr_buy_item_flags(10),"north_sallet","bo_pw_armor_head", spr_buy_item_triggers("itm_north_sallet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_closed_sallet_with_neckguard",spr_buy_item_flags(10),"north_neckguard","bo_pw_armor_head", spr_buy_item_triggers("itm_north_neckguard", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ...
  ("cm_buy_open_klappvisier",spr_buy_item_flags(10),"klappvisier_open","bo_pw_armor_head", spr_buy_item_triggers("itm_klappvisier_open", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_klappvisier",spr_buy_item_flags(10),"klappvisier","bo_pw_armor_head", spr_buy_item_triggers("itm_klappvisier", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_milanese_helmet",spr_buy_item_flags(10),"dejawolf_sallet","bo_pw_armor_head", spr_buy_item_triggers("itm_dejawolf_sallet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_sugarloaf",spr_buy_item_flags(10),"sugarloaf","bo_pw_armor_head", spr_buy_item_triggers("itm_sugarloaf", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_sultan_helmet",spr_buy_item_flags(10),"helm_sultan_saracens_market","bo_pw_armor_head", spr_buy_item_triggers("itm_helm_sultan_saracens_market", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_flemish_armet",spr_buy_item_flags(10),"flemish_armet","bo_pw_armor_head", spr_buy_item_triggers("itm_flemish_armet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_great_bascinet",spr_buy_item_flags(10),"greatbascinet1","bo_pw_armor_head", spr_buy_item_triggers("itm_greatbascinet1", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_greathelm_with_bascinet",spr_buy_item_flags(10),"greathelm1","bo_pw_armor_head", spr_buy_item_triggers("itm_greathelm1", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("cm_buy_weimar_helmet",spr_buy_item_flags(10),"weimarhelm","bo_pw_armor_head", spr_buy_item_triggers("itm_weimarhelm", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ...
  ("cm_buy_milanese_sword",spr_buy_item_flags(10),"milanese_sword","bo_pw_weapon", spr_buy_item_triggers("itm_milanese_sword", resources=["itm_iron_bar"], engineer=4)),
  ("cm_buy_scottish_sword",spr_buy_item_flags(10),"scottish_sword","bo_pw_weapon", spr_buy_item_triggers("itm_scottish_sword", resources=["itm_iron_bar"], engineer=4)),
  ...
  ("cm_buy_langes_messer",spr_buy_item_flags(15),"grosse_messer_b","bo_pw_weapon", spr_buy_item_triggers("itm_grosse_messer_b", resources=["itm_iron_bar_long"], engineer=7)),
  ("cm_buy_longsword",spr_buy_item_flags(15),"longsword_b","bo_pw_weapon", spr_buy_item_triggers("itm_longsword_b", resources=["itm_iron_bar_long"], engineer=7)),
  ("cm_buy_german_longsword",spr_buy_item_flags(15),"german_bastard_sword","bo_pw_weapon", spr_buy_item_triggers("itm_german_bastard_sword", resources=["itm_iron_bar_long"], engineer=7)),
  ...
  ("cm_buy_short_poleaxe",spr_buy_item_flags(5),"poleaxe_no3","bo_pw_weapon_big", spr_buy_item_triggers("itm_poleaxe_no3", resources=["itm_wood_pole", "itm_iron_piece"], engineer=3)),
  ("cm_buy_german_poleaxe",spr_buy_item_flags(5),"german_poleaxe","bo_pw_weapon_big", spr_buy_item_triggers("itm_german_poleaxe", resources=["itm_wood_pole", "itm_iron_piece"], engineer=3)),
  ...
  ("pw_change_troop_footman",spr_use_time(60),"heavy_practicesword","bo_pw_weapon", spr_change_troop_triggers("trp_footman", cost=3000)),
  ...
  ("pw_change_troop_lancer",spr_use_time(70),"arena_lance","bo_pw_weapon_big", spr_change_troop_triggers("trp_lancer", cost=3000)),
  ...
  ("pw_change_troop_dismounted_knight",spr_use_time(90),"shield_heater_c","bo_pw_shield_kite_small", spr_change_troop_triggers("trp_dismounted_knight", cost=5000)),
