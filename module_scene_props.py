...
scene_props = [
  ...
  ("pw_buy_arrows",spr_buy_item_flags(1),"arrow_b","bo_pw_weapon", spr_buy_item_triggers("itm_arrows", resources=["itm_stick"], engineer=1)),
  ("pw_buy_barbed_arrows",spr_buy_item_flags(1),"barbed_arrow","bo_pw_weapon", spr_buy_item_triggers("itm_barbed_arrows", resources=["itm_stick", "itm_iron_piece"], engineer=1)),
  ("pw_buy_khergit_arrows",spr_buy_item_flags(1),"arrow","bo_pw_weapon", spr_buy_item_triggers("itm_khergit_arrows", resources=["itm_stick", "itm_iron_piece"], engineer=1)),
  ("pw_buy_bodkin_arrows",spr_buy_item_flags(1),"piercing_arrow","bo_pw_weapon", spr_buy_item_triggers("itm_bodkin_arrows", resources=["itm_stick", "itm_iron_piece"], engineer=1)),
  ...
  ("pw_buy_bolts",spr_buy_item_flags(1),"bolt","bo_pw_weapon_small", spr_buy_item_triggers("itm_bolts", resources=["itm_stick"], engineer=1)),
  ("pw_buy_steel_bolts",spr_buy_item_flags(1),"bolt","bo_pw_weapon_small", spr_buy_item_triggers("itm_steel_bolts", resources=["itm_stick", "itm_iron_piece"], engineer=1)),
