  ...
  return [(ti_on_scene_prop_init,
    ...
    (ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      ...
      (agent_is_alive, ":agent_id"), (agent_get_player_id, ":player_id", ":agent_id"),
...
scene_props = [
  ...
  ("cm_sitable_gothic_chair",spr_use_time(1),"sitable_gothic_chair","bo_sitable_gothic_chair", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_tavern_chair_a", spr_use_time(1), "tavern_chair_a", "bo_tavern_chair_a", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_tavern_chair_b",spr_use_time(1),"tavern_chair_b","bo_tavern_chair_b", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_tavern_chair_c",spr_use_time(1), "tavern_chair_c","bo_tavern_chair_c", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_chair_trunk_b", spr_use_time(1), "chair_trunk_b", "bo_chair_trunk_b", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_chair_trunk_c", spr_use_time(1), "chair_trunk_c", "bo_chair_trunk_c", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_chair_trestle",spr_use_time(1),"chair_trestle","bo_chair_trestle", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_bench_tavern", spr_use_time(1), "cm_bench_tavern", "bo_cm_bench_tavern", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_bench_tavern_b", spr_use_time(1), "bench_tavern_b", "bo_bench_tavern_b", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_chair_castle_a", spr_use_time(1), "cm_chair_castle_a", "bo_cm_chair_castle_a", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_pillow_blue",spr_use_time(1),"pillow_blue","bo_pillow_blue", spr_chairs("anim_prop_sitting_pillow_male","anim_prop_sitting_pillow_female")),
  ("cm_sitable_pillow_red",spr_use_time(1),"pillow_red","bo_pillow_red", spr_chairs("anim_prop_sitting_pillow_male","anim_prop_sitting_pillow_female")),
  ("cm_sitable_pillow_red_small",spr_use_time(1),"pillow_red_small","bo_pillow_red_small", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_pillow_blue_small",spr_use_time(1),"pillow_blue_small","bo_pillow_blue_small", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
  ("cm_sitable_invisable",spr_use_time(1),"invisable","bo_invisable_chair", spr_chairs("anim_prop_sitting_leg_crossed", "anim_prop_sitting")),
