...
####################################################################################################################
  ...
  ["craftsman","Craftsman","a craftsman",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_8|agi_8|pw_attr,wpex(50,30,30,20,20,20),knows_pw|knows_musician_3|knows_power_strike_1|knows_riding_1|knows_engineer_2|knows_labouring_1|knows_tailoring_3,default_face_1,default_face_2],
  ...
  ["dismounted_knight","Dismounted Knight","a dismounted knight",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_16|agi_14|pw_attr,wpex(100,125,125,20,60,40),knows_pw|knows_ironflesh_5|knows_power_strike_4|knows_shield_2|knows_athletics_3|knows_riding_2,default_face_1,default_face_2],
  ...
  ["traveler","Traveler","a traveler",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_10|agi_13|pw_attr,wpex(60,40,50,10,20,60),knows_pw|knows_musician_3|knows_ironflesh_1|knows_power_strike_2|knows_athletics_5|knows_sailing_7|knows_riding_3|knows_labouring_1|knows_herding_1|knows_tailoring_2,default_face_1,default_face_2],
  ...
  ["lord","Lord","the lord",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_15|agi_15|pw_attr,wpex(115,115,115,50,70,50),knows_pw|knows_musician_3|knows_leadership_1|knows_ironflesh_6|knows_power_strike_4|knows_shield_2|knows_athletics_2|knows_riding_5,default_face_1,default_face_2],
