...
####################################################################################################################
  ...
  ["serf","Serf","a serf",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_5|agi_5|pw_attr,wpex(30,30,30,0,0,50),knows_pw|knows_musician_3|knows_power_strike_1|knows_labouring_5|knows_engineer_1|knows_tailoring_1|knows_herding_3|knows_riding_1,default_face_1,default_face_2],
  ...
  ["healer","Healer","a healer",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_8|agi_8|pw_attr,wpex(40,10,20,0,0,5),knows_pw|knows_musician_3|knows_riding_1|knows_wound_treatment_1|knows_tailoring_2|knows_herding_1,default_face_1,default_face_2],
