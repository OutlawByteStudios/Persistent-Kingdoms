...
####################################################################################################################
  ...
  ["healer","Healer","a healer",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_8|agi_8|pw_attr,wpex(40,10,20,0,0,5),knows_pw|knows_riding_1|knows_wound_treatment_1|knows_tailoring_2|knows_herding_1,default_face_1,default_face_2],
  ...
  ["engineer","Engineer","an engineer",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_10|agi_12|pw_attr,wpex(90,50,60,30,65,50),knows_pw|knows_ironflesh_2|knows_power_strike_2|knows_athletics_2|knows_labouring_1|knows_engineer_5|knows_riding_2|knows_looting_1|knows_sailing_4,default_face_1,default_face_2],
  ["master_smith","Master Smith","a master smith",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_12|agi_12|pw_attr,wpex(100,55,70,30,70,50),knows_pw|knows_ironflesh_3|knows_power_strike_3|knows_athletics_2|knows_labouring_1|knows_engineer_7|knows_riding_2|knows_looting_2|knows_sailing_4,default_face_1,default_face_2],
