...
####################################################################################################################
  ...
  ["healer","Healer","a healer",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_8|agi_8|pw_attr,wpex(40,10,20,0,0,5),knows_pw|knows_musician_3|knows_riding_2|knows_athletics_1|knows_wound_treatment_7|knows_tailoring_2|knows_herding_1,default_face_1,default_face_2],
  ["footman","Footman","a footman",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_14|agi_15|pw_attr,wpex(110,110,110,10,45,80),knows_pw|knows_ironflesh_5|knows_power_strike_4|knows_power_throw_2|knows_shield_1|knows_athletics_5|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
  ...
  ["lancer","Lancer","a lancer",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_14|agi_15|pw_attr,wpex(90,60,120,10,30,80),knows_pw|knows_ironflesh_3|knows_power_strike_3|knows_power_throw_2|knows_athletics_1|knows_riding_6,default_face_1,default_face_2],
  ["man_at_arms","Man at Arms","a man at arms",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_15|agi_15|pw_attr,wpex(100,120,120,20,50,30),knows_pw|knows_ironflesh_4|knows_power_strike_5|knows_shield_1|knows_athletics_2|knows_riding_4,default_face_1,default_face_2],
  ["mounted_knight","Mounted Knight","a mounted knight",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_16|agi_14|pw_attr,wpex(100,110,110,20,50,30),knows_pw|knows_ironflesh_5|knows_power_strike_4|knows_shield_1|knows_athletics_2|knows_riding_3,default_face_1,default_face_2],
  ["sergeant","Sergeant","a sergeant",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_15|agi_15|pw_attr,wpex(125,110,120,20,60,40),knows_pw|knows_ironflesh_5|knows_power_strike_5|knows_shield_2|knows_athletics_5|knows_riding_2,default_face_1,default_face_2],
  ["dismounted_knight","Dismounted Knight","a dismounted knight",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_16|agi_14|pw_attr,wpex(100,125,110,20,60,40),knows_pw|knows_ironflesh_5|knows_power_strike_4|knows_shield_2|knows_athletics_3|knows_riding_2,default_face_1,default_face_2],
  ...
  ["doctor","Doctor","a doctor",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_10|agi_10|pw_attr,wpex(70,40,50,10,20,30),knows_pw|knows_musician_3|knows_athletics_2|knows_power_strike_2|knows_wound_treatment_5|knows_riding_2,default_face_1,default_face_2],
  ...
  ["lord","Lord","the lord",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_16|agi_15|pw_attr,wpex(115,115,115,50,70,50),knows_pw|knows_musician_3|knows_leadership_1|knows_ironflesh_6|knows_power_strike_4|knows_shield_2|knows_athletics_3|knows_riding_5,default_face_1,default_face_2],
  ["ruffian","Ruffian","a ruffian",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_15|agi_12|pw_attr,wpex(90,85,90,10,20,80),knows_pw|knows_ironflesh_3|knows_power_strike_4|knows_athletics_3|knows_riding_1|knows_looting_2,default_face_1,default_face_2],
