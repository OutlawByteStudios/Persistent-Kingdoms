  ...
  ("escape_menu", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (assign, "$g_presentation_obj_escape_menu_private_message_reply", -1),
      (try_begin),
          (neq, "$g_private_message_player_id", 0),
          (player_is_active, "$g_private_message_player_id"),
          (create_button_overlay, reg0, "str_private_message_reply", 0),
          (assign, "$g_presentation_obj_escape_menu_private_message_reply", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (val_add, ":cur_y", escape_menu_item_height),
      (try_end),
      ...
      (try_begin),
        (gt, "$g_presentation_obj_escape_menu_private_message_start", -1),
        (val_sub, ":cur_y", escape_menu_item_height),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_escape_menu_private_message_start", pos1),
      (try_end),

      (try_begin),
        (gt, "$g_presentation_obj_escape_menu_private_message_reply", -1),
        (val_sub, ":cur_y", escape_menu_item_height),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_escape_menu_private_message_reply", pos1),
      (try_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_private_message_start"),
        (presentation_set_duration, 0),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_private_message_reply"),
        (neq, "$g_private_message_player_id", 0),
        (player_is_active, "$g_private_message_player_id"),
        (presentation_set_duration, 0),
        (assign, "$g_chat_box_event_type", chat_event_type_private_message),
     ...
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (this_or_next | eq, "$g_list_players_event_value", faction_admin_action_outlaw_player),
   ...
   [(ti_on_presentation_load,
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":overlay_id"),
      ...
      (else_try),
        (eq, ":string_id", "str_toggle_basic_name_labels"),
        (val_add, "$g_basic_name_labels", 1),
        (val_mod, "$g_basic_name_labels", 2),
      (else_try),
