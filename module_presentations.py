...
("bank_menu", prsntf_manual_end_only, 0, # allows for bank management
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (multiplayer_get_my_player, ":my_player_id"),
      (try_begin),
        (le, "$g_presentation_obj_bank_amount", 0),
        (player_get_gold, ":my_gold", ":my_player_id"),
        (assign, "$g_presentation_obj_bank_amount", ":my_gold"),
      (try_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        ...
        (multiplayer_send_int_to_server, client_event_bank_management, "$g_presentation_bank_amount", 0, "$g_bank_instance_id"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_bank_deposit"),
        (multiplayer_send_int_to_server, client_event_bank_management, "$g_presentation_bank_amount", 1, "$g_bank_instance_id"),
      (try_end),
      ]),
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":current_time"),
