   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_for_range_backwards, ":string_id", action_menu_strings_begin, action_menu_strings_end),
        (try_begin),
          (eq, ":string_id", "str_display_name_labels"),
          (try_begin),
          ...
          (try_end),
        (else_try),
          (eq, ":string_id", "str_display_basic_name_labels"),
          (try_begin),
            (eq, "$g_basic_name_labels", 1),
            (create_button_overlay, reg0, "str_hide_basic_name_labels"),
          (else_try),
        ...
        (else_try),
          ...
          (try_begin),
            (eq, "$g_hide_faction_in_name_labels", 1),
            (create_button_overlay, reg0, "str_display_faction_in_name_labels"),
          (else_try),
            (create_button_overlay, reg0, "str_hide_faction_in_name_labels"),
          (try_end),
        (else_try),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":overlay_id"),
      ...
      (else_try),
        ...
        (else_try),
          (overlay_set_text, ":overlay_id", "str_hide_faction_in_name_labels"),
        (try_end),
      (else_try),
        (eq, ":string_id", "str_display_basic_name_labels"),
        ...
        (try_begin),
          (eq, "$g_basic_name_labels", 1),
          (overlay_set_text, ":overlay_id", "str_hide_basic_name_labels"),
        (else_try),
      ...
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":string_id", "str_clear_projectiles"),
        (call_script, "script_clear_projectiles"),
      (try_end),
      (try_begin),
