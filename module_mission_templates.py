...
sitting_check_chair = (1, 0, 0, [], # server: handle agents sitting
   [(multiplayer_is_server),
    (try_for_agents, ":agent_id"),
      ...
      (try_begin),
        (this_or_next|eq, ":anim", "anim_prop_sitting"),
        (this_or_next|eq, ":anim", "anim_prop_sitting_pillow_male"),
        (eq, ":anim", "anim_prop_sitting_pillow_female"),
        (try_begin),
          (agent_get_position, pos0, ":agent_id"),
          (prop_instance_get_position, pos1, ":instance"),
          (get_distance_between_positions, ":dist", pos0, pos1),
          (gt, ":dist", 60),
          (call_script, "script_cf_do_custom_anims", ":agent_id", "anim_prop_sitting_finish", 0),
          (call_script, "script_cf_do_custom_anims", ":agent_id", "anim_prop_sitting_finish", 1),
